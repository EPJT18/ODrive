...
//private:
    ...
    uint32_t last_current_meas_timestamp_ = 0;
    ...
    float I_leak_ = 0.0f; // close to zero if only two current sensors are available
    ...
    float overcurrent_trip_level_ = 0.0f; // [A] set in setup()
